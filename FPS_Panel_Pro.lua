...
Toggle(Pages.Visuals,"Skeleton ESP","Draws a lightweight bone skeleton using screen-space lines.",function() return Config.ESPSkeleton end,function(v) Config.ESPSkeleton=v; task.defer(UpdateESP) end)
                ...
                if distWorld<=Config.ESPMaxDistance then
                    ...
                    if e then
                        ...
                        if onScreen and rootZ>0 then
                            ...
                            UpdateSkeleton(e,char,color,cam)
                        else
                            e.container.Visible=false
