...
UpdateESP=function()
    ...
    -- primitives. This prevents stale boxes/tracers/skeleton lines from
    -- surviving a toggle-off, character respawn, or an interrupted update.
                        ...
                        if onScreen and rootZ>0 then
                            ...
                            if rootZ>0 and root2d.X>=0 and root2d.X<=view.X and root2d.Y>=0 and root2d.Y<=view.Y then
                                ...
                                local halfH=math.clamp(44/(rootZ^.15),20,140)
                                    pcall(UpdateLegacyBox,e,root2d.X-halfW,root2d.Y-halfH,root2d.X+halfW,root2d.Y+halfH,color)
                            else
